...
"""
A tool to control port power/led of USB hub

Copyright © 2006, 2011, 2016 Free Software Initiative of Japan

Original Author: NIIBE Yutaka  <gniibe@fsij.org>

This file is (originally) named hub_control.py, a part of Gnuk, a GnuPG USB Token implementation.

Copyright © 2017 林博仁

USB Power Control is free software: you can redistribute it and/or modify it
under the terms of the GNU General Public License as published by
the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.

USB Power Control is distributed in the hope that it will be useful, but WITHOUT
